    ...
    <main class="main-wrapper clearfix">
        ...
        <div class="row page-title clearfix">
            <div class="page-title-left">
                ...
                <p class="page-title-description mr-0 d-none d-md-inline-block">Village Profile</p>
            </div>
            <!-- /.page-title-left -->
            <div class="page-title-right d-none d-sm-inline-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Form Create Village Profile</li>
                </ol>
            </div>
            <!-- /.page-title-right -->
        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('postalcode') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type postalcode" value="{{ old('postalcode') }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('province') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type province" value="{{ old('province') }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('subdistrict') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type subdistrict" value="{{ old('subdistrict') }}">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('phone') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type phone" value="{{ old('phone') }}">
                                                    @if ($errors->has('phone'))
                                                        <div class="invalid-feedback">
                                                            {{ $errors->first('phone') }}
                                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('fax') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type fax" value="{{ old('fax') }}">
                                                    @if ($errors->has('fax'))
                                                        <div class="invalid-feedback">
                                                            {{ $errors->first('fax') }}
                                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('ig') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type instagram link" value="{{ old('ig') }}">
                                                    @if ($errors->has('ig'))
                                                        <div class="invalid-feedback">
                                                            {{ $errors->first('ig') }}
                                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('fb') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type facebook link" value="{{ old('fb') }}">
                                                    @if ($errors->has('fb'))
                                                        <div class="invalid-feedback">
                                                            {{ $errors->first('fb') }}
                                                        </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('yt') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type yt" value="{{ old('yt') }}">
                                                    @if ($errors->has('yt'))
                                                        <div class="invalid-feedback">
                                                            {{ $errors->first('yt') }}
                                                        </div>
