    ...
    <main class="main-wrapper clearfix">
        ...
        <div class="row page-title clearfix">
            <div class="page-title-left">
                ...
                <p class="page-title-description mr-0 d-none d-md-inline-block">Event</p>
            </div>
            <!-- /.page-title-left -->
            <div class="page-title-right d-none d-sm-inline-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('events.index') }}">Event</a>
                    </li>
                    <li class="breadcrumb-item active">Form Update Event</li>
                </ol>
            </div>
            <!-- /.page-title-right -->
        </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="date" id="date"
                                                    class="form-control datepicker" value="{{ date('d-m-Y', strtotime($event->date)) }}"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('locations') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type locations" value="{{ $event->locations }}">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control @error('location_url') is-invalid @enderror"
                                                        ...
                                                        placeholder="Type url location" value="{{ $event->location_url }}">
                                        ...
                                        <div class="col-md-12 widget-holder">
                                            <div class="widget-bg">
                                                ...
                                                <textarea data-toggle="wysiwyg" id="description" name="description">{{ $event->description }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('image') is-invalid @enderror" id="image"
                                                name="image" type="file" value="{{ $event->image }}">
