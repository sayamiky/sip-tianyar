      ...
      <div class="container">
        <div class="flex flex-wrap justify-center -mx-4">
          <div class="w-full px-4">
            ...
            >
              <img
                src="{{ asset('assets/web/images/blog/blog-details-01.jpg') }}"
                alt="image"
                ...
                <div class="flex flex-wrap items-center p-4 pb-4 sm:p-8">
                  <div class="flex items-center mb-4 mr-5 md:mr-10">
                    <div class="w-10 h-10 mr-4 overflow-hidden rounded-full">
                      <img
                        src="{{ asset('assets/web/images/blog/author-01.png') }}"
                        alt="image"
                        class="w-full"
                      />
                    </div>
            ...
            <div class="flex flex-wrap -mx-4">
              ...
              <div class="w-full px-4 lg:w-4/12">
                <div>
                  ...
                  <div class="flex flex-wrap mb-8 -mx-4">
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{ asset('assets/web/images/blog/article-author-01.png') }}"
                            alt="image"
                            class="w-full"
                          />
                        </div>
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{ asset('assets/web/images/blog/article-author-02.png') }}"
                            alt="image"
                            class="w-full"
                          />
                        </div>
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{ asset('assets/web/images/blog/article-author-03.png') }}"
                            alt="image"
                            class="w-full"
                          />
                        </div>
                    ...
                    <div class="w-full px-4 md:w-1/2 lg:w-full">
                      ...
                      >
                        ...
                        >
                          <img
                            src="{{ asset('assets/web/images/blog/article-author-04.png') }}"
                            alt="image"
                            class="w-full"
                          />
                        </div>
                  ...
                  <div
                    class="mb-12 overflow-hidden rounded wow fadeInUp"
                    data-wow-delay=".1s"
                  >
                    <img
                      src="{{ asset('assets/web/images/blog/bannder-ad.png') }}"
                      alt="image"
                      class="w-full"
                    />
                  </div>
