<footer class="bg-black pt-20 lg:pt-[120px] relative z-10 wow fadeInUp" data-wow-delay=".15s">
        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
                <div class="w-full mb-10">
                  ...
                  2xl:max-w-[120px]
                ">
                                <img src="{{ asset('assets/web/images/footer/brands/tailgrids.svg')}}" alt="tailgrids" />
                            </a>
                        </li>
                        <li>
                  ...
                  2xl:max-w-[120px]
                ">
                                <img src="{{ asset('assets/web/images/footer/brands/ayroui.svg')}}" alt="ayroui" />
                            </a>
                        </li>
                        <li>
                  ...
                  2xl:max-w-[120px]
                ">
                                <img src="{{ asset('assets/web/images/footer/brands/ecommerce-html')}}.svg"
                                    alt="ecommerce-html" />
                            </a>
                        </li>
                        <li>
                  ...
                  2xl:max-w-[120px]
                ">
                                <img src="{{ asset('assets/web/images/footer/brands/graygrids.svg')}}" alt="graygrids" />
                            </a>
                        </li>
                        <li>
                  ...
                  2xl:max-w-[120px]
                ">
                                <img src="{{ asset('assets/web/images/footer/brands/lineicons.svg')}}" alt="lineicons" />
                            </a>
                        </li>
                        <li>
                  ...
                  2xl:max-w-[120px]
                ">
                                <img src="{{ asset('assets/web/images/footer/brands/uideck.svg')}}" alt="uideck" />
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div>
        <span class="absolute left-0 top-0 z-[-1]">
            <img src="{{ asset('assets/web/images/footer/shape-1.svg') }}" alt="" />
        </span>

        <span class="absolute bottom-0 right-0 z-[-1]">
            <img src="{{ asset('assets/web/images/footer/shape-3.svg')}}" alt="" />
        </span>
