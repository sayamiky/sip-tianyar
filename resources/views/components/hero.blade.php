          ...
          "
                    ...
                    {{-- <ul class="flex flex-wrap items-center justify-center mb-10">
                        ...
                        <li>
                            <a href="https://github.com/tailgrids/play-tailwind" target="_blank"
                                class="flex items-center px-6 py-4 text-base font-medium text-white transition duration-300 ease-in-out sm:px-10 hover:opacity-70">
                                Star on Github
                                <span class="pl-2">
            ...
            <div class="w-full px-4">
                <div class="mx-auto max-w-[845px] relative z-10 wow fadeInUp" data-wow-delay=".25s">
                    <div class="mt-16">
                        <img src="{{ asset('assets/web/images/hero/hero-image.jpg') }}" alt="hero"
