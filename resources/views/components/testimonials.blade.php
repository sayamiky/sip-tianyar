    ...
    <div class="container px-4">
        ...
        <div class="flex flex-wrap">
          ...
          ">
                ...
                mr-5
              ">
                            <img src="{{ asset('assets/web/images/testimonials/author-01.png')}}" alt="author" />
                        </div>
          ...
          ">
                ...
                mr-5
              ">
                            <img src="{{ asset('assets/web/images/testimonials/author-02.png')}}" alt="author" />
                        </div>
                        <div class="ud-testimonial-meta">
          ...
          ">
                ...
                mr-5
              ">
                            <img src="{{ asset('assets/web/images/testimonials/author-03.png')}}" alt="author" />
                        </div>
                        <div class="ud-testimonial-meta">
                    ...
                    <div class="flex flex-wrap items-center ud-brands-logo">
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://tailgrids.com" target="_blank" rel="nofollow noopner">
                                <img src="{{ asset('assets/web/images/brands/tailgrids.svg')}}" alt="tailgrids"
                                    class="duration-300 grayscale hover:filter-none" />
                            </a>
                        </div>
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://ayroui.com" target="_blank" rel="nofollow noopner">
                                <img src="{{ asset('assets/web/images/brands/ayroui.svg')}}" alt="ayroui"
                                    class="duration-300 grayscale hover:filter-none" />
                            </a>
                        </div>
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://uideck.com" target="_blank" rel="nofollow noopner">
                                <img src="{{ asset('assets/web/images/brands/uideck.svg')}}" alt="uideck"
                                    class="duration-300 grayscale hover:filter-none" />
                            </a>
                        </div>
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://graygrids.com" target="_blank" rel="nofollow noopner">
                                <img src="{{ asset('assets/web/images/brands/graygrids.svg')}}" alt="graygrids"
                                    class="duration-300 grayscale hover:filter-none" />
                            </a>
                        </div>
                        <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                            <a href="https://lineicons.com" target="_blank" rel="nofollow noopner">
                                <img src="{{ asset('assets/web/images/brands/lineicons.svg')}}" alt="lineicons"
                                    class="duration-300 grayscale hover:filter-none" />
                            </a>
                        </div>
                    </div>
