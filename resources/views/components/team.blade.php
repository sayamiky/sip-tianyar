    ...
    <div class="container">
        ...
        <div class="flex flex-wrap justify-center -mx-4">
            <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
              ...
              mb-6
            ">
                        <img src="{{ asset('assets/web/images/team/team-01.png')}}" alt="image"
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
              ...
              mb-6
            ">
                        <img src="{{ asset('assets/web/images/team/team-02.png')}}" alt="image"
                            class="w-full rounded-full" />
                        <span class="absolute top-0 left-0 z-[-1]">
                            <svg width="71" height="82" viewBox="0 0 71 82" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
              ...
              mb-6
            ">
                        <img src="{{ asset('assets/web/images/team/team-03.png')}}" alt="image"
                            class="w-full rounded-full" />
                        <span class="absolute top-0 left-0 z-[-1]">
                            <svg width="71" height="82" viewBox="0 0 71 82" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
